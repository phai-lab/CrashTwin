...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--results_out_path', default='',
                             help='Full path for saving results when '
                                  '--save_results is set.')
    ...
    self.parser.add_argument('--kitti_split', default='3dop',
                             help='different validation split for kitti: '
                                  '3dop | subcnn')
    self.parser.add_argument('--test_focal_length', type=float, default=-1)
